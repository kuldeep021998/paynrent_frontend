    ...
    return (
      <div>
        {buttonStatus.upload ? <><Button fullWidth variant="contained" component="label">
          ...
          <><Button variant="contained" onClick={handleSavePicture} color="primary">Save</Button><Button variant="contained" onClick={handleDiscard}>Discard</Button></>}
      </div>
    )
  }
            ...
            <div className={classes.box}>
              <div className={classes.center}>
                <Grid spacing={2} container>
                  ...
                  <Grid item xs={12}>
                    <TextField fullWidth value={categoryName} label="Category Name" onChange={(event) => setCategoryName(event.target.value)} />
                  </Grid>
                  <Grid xs={6} item>
