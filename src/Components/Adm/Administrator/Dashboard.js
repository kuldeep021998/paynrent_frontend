    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            ...
            <Grid container spacing={2}>
                <Grid item xs={12}>
                    <div sx={{ paddingTop: 5, paddingLeft: 5, display: 'flex', width: 200, justifyContents: 'center', alignItems: 'center' }}>
                ...
                <Grid item xs={10}>
                    <Routes>
                        ...
                        <Route element={<DisplayAllCatergory />} path='/display_all_category' />
                        <Route element={<SubCategory />} path='/subcategory' />
                        <Route element={<DisplayAllSubCategory />} path='/display_all_subcategory' />
                        <Route element={<Company />} path="/company" />
                        <Route element={<DisplayAllCompany />} path="/display_all_company" />
